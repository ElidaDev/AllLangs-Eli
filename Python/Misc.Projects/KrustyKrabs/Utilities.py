...
#Text color https://gist.github.com/kamito/704813 This is where the colors were found
#I watched a video on how to do this with classes, but didnt fully understand so i didnt use classes and i used a function
